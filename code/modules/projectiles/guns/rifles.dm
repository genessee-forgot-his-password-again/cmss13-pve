...
/obj/item/weapon/gun/rifle/m16a5
	...
	flags_gun_features = GUN_CAN_POINTBLANK|GUN_AUTO_EJECTOR|GUN_AMMO_COUNTER|GUN_AUTO_EJECT_CASINGS
	start_automatic = TRUE

/obj/item/weapon/gun/rifle/m16a5/handle_starting_attachment()
	..()
...
/obj/item/weapon/gun/rifle/m16a5/set_gun_config_values()
	..()
	set_fire_delay(FIRE_DELAY_TIER_11)
	set_burst_amount(BURST_AMOUNT_TIER_3)
	set_burst_delay(FIRE_DELAY_TIER_11)
...
/obj/item/weapon/gun/rifle/m16a5/tactical
	random_spawn_chance = 100
	random_spawn_rail = list(
		/obj/item/attachable/reddot,
		/obj/item/attachable/reflex,
